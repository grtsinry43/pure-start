...
const AppearanceSettings = () => {
    ...
    const [selectedColor, setSelectedColor] = useState("210 100% 62.03%")

    const onColorChange = (color: string) => {
        setSelectedColor(color)
        dispatch({
            type: 'appearanceSettings/changePrimaryColor',
            payload: color
        })
    ...
    const colorOptions = [
        {value: "210 100% 80%", label: "蓝色"},
        {value: "120 100% 80%", label: "绿色"},
        {value: "0 100% 80%", label: "红色"},
        {value: "60 100% 80%", label: "黄色"},
        {value: "300 100% 80%", label: "紫色"},
    ];
                    ...
                    <CardContent className="p-6">
                        <div className="space-y-6">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="grid grid-cols-5 gap-3">
                                    {colorOptions.map((color) => (
                                        <button
                                            ...
                                            className={`h-10 w-full rounded-md cursor-pointer ring-offset-foreground transition-all hover:scale-105 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 ${
                                ...
                                <p className="text-sm text-muted-foreground"> 在这里选择您喜欢的主题颜色 </p>
                            </div>
